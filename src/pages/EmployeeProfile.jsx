...
const EmployeeProfile = () => {
  ...
  const loadEmployeeDetails = async () => {
    try {
      // TODO: API call to /api/employees/:code with all related tables
  ...
  return (
    <div className="space-y-6 animate-fadeInUp">
      ...
      <button
        ...
        className="flex items-center space-x-2 text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors scroll-animate"
      >
      ...
      {/* Profile Header Card */}
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 p-6 scroll-animate">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            <div className="w-20 h-20 rounded-full bg-primary-600 dark:bg-primary-500 flex items-center justify-center text-white text-2xl font-bold">
              {emp.name?.charAt(0)}
            </div>
            <div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 scroll-animate">
              ...
              <div className="space-y-4">
                ...
                {emp.cv_path && (
                  <div className="flex space-x-2">
                    <button className="px-4 py-2 bg-primary-600 hover:bg-primary-700 text-white rounded-lg flex items-center space-x-2 transition-colors">
                      <Download className="w-4 h-4" />
                      <span>Download CV</span>
                    </button>
                    <button className="px-4 py-2 bg-gray-600 hover:bg-gray-700 text-white rounded-lg flex items-center space-x-2 transition-colors">
        ...
        {editMode && (
          <div className="sticky bottom-0 bg-gray-50 dark:bg-gray-700 border-t border-gray-200 dark:border-gray-600 p-4 flex justify-end space-x-3">
            <button
