...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-primary-700 to-primary-700 dark:from-gray-900 dark:to-gray-800">
      <header className="h-16 bg-white/10 dark:bg-black/20 backdrop-blur-sm border-b border-white/20 dark:border-gray-700 flex items-center px-6">
        <img src={logo} alt="EwandzDigital" className="h-10" />
      </header>
